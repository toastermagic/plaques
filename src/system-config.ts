...
const packages: any = {
  ...
  'ng2-material': {format: 'cjs', defaultExtension: 'js', main: 'index.js'},
  'd3': {main: 'd3.js'},
  'd3-cloud': {format: 'cjs', main: 'build/d3.layout.cloud.js'},
  'd3-dispatch': {main: 'build/d3-dispatch.js'}
};
...
const barrels: string[] = [
  ...
  'app', 'app/shared', 'app/tags', 'app/plaques',
  /** @cli-barrel */
];
